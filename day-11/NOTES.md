...
**Insights**
1. The single best feature already reaches 0.909 accuracy; all 30 together reach 0.979.
2. **9 features get within 2% of the full model** (0.960) — the other 21 buy almost nothing.
3. 5 of the 29 additions *lowered* CV accuracy, so rank-order-and-add is a rough heuristic, not a feature selector.
