...
| 10 | sklearn `iris` | How much accuracy do you lose keeping only the top-k features? |
...
| 19 | sklearn `breast_cancer` | Which features are redundant with each other? |
...
| 30 | seaborn `penguins` | How skewed are the features, and does a log transform fix the worst one? |
...
| 35 | sklearn `wine` | Where are the outliers, and how much do they move the summary statistics? |
