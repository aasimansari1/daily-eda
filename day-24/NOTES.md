# Day 24 — seaborn `mpg` (398 rows · 8 features)
...
**Insights**
1. **cylinders** and **displacement** are the most redundant pair at |r| = 0.95 (positive) — near-duplicates for a linear model.
2. 6 of 36 feature pairs exceed |r| = 0.8, so the 6 columns hold noticeably fewer than 6 independent dimensions.
3. Typical pair correlation is only |r| = 0.62, meaning the redundancy is concentrated in a few clusters rather than spread across the table.
